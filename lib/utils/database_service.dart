...
class DatabaseService {
  ...
  /// Columns
  ///Table
  static final passTable = 'pass_table';
  ///Fields
  static final idField = 'id';
  static final nameField='name';
  static final usernameField='username';
  static final passField = 'pass';
  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
      CREATE TABLE $passTable (
        ...
        $passField TEXT NOT NULL
      )
      ''');
  }

  // functions to insert data
  Future<int> insert(PassModel pass) async {
    Database db = await instance.databse;
    return await db.insert(passTable, pass.getMap());
  }
